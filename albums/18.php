...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/camille_organ.jpg" class="img-fluid mx-auto d-block" alt="hahn pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Symphony No. 3, "Organ" / Organ Concerto </h2>
				<p class="text-primary">Camille Saint-Saens (Composer),
				Francis Poulenc (Composer), Samuel Barber (Composer), Christoph Eschenbach (Conductor),
				The Philadelphia Orchestra (Orchestra), Olivier Latry (Performer)  Format: Audio CD</p>
                ...
                <p>The Philadelphia Orchestra:<br>
				  Christoph Eschenbach<br>
				   Original Release Date : 2006<br>
				   <span class="fa fa-star checked"></span>
					<span class="fa fa-star checked"></span>
					<span class="fa fa-star checked"></span>
					<span class="fa fa-star checked"></span>
					<span class="fa fa-star"></span><br>
				   4.2 out of 5 stars<br>
				   Audio CD<br>
                   €19.00<br>
                   Only 11 left in stock.</p>
