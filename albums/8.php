...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/sibelius2.jpg" class="img-fluid mx-auto d-block" alt=" pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Jean Sibelius - Complete Works </h2>
				<p class="text-primary">Jean Sibelius (Composer), Heikki Seppänen (Conductor), Estonian Philharmonic Chamber Choir (Orchestra)  Format: Audio CD</p>
                ...
                <p>Estonian Philharmonic Chamber Choir:<br>
				  Heikki Seppänen<br>
