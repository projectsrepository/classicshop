...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/requiem2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Mozart: Requiem</h2>
				<p class="text-primary">Wolfgang Amadeus Mozart (Composer), Herbert von Karajan (Conducter), Wiener Philharmoniker (Orchestra)  Format: Audio CD</p>
