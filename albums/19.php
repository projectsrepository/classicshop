...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/haydn104.jpg" class="img-fluid mx-auto d-block" alt="hahn pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Haydn: Symphony No. 101 "The Clock"/ Symphony No. 104 "London"</h2>
				<p class="text-primary">Franz Joseph Haydn (Composer), Sir Charles Mackerras (Conductor), Orchestra of St. Luke's (Orchestra)  Format: Audio CD</p>
