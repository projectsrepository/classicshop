...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/vivaldi2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Antonio Vivaldi: The Four Seasons </h2>
				<p class="text-primary">Giuliano Carmignola (Artist), Antonio Vivaldi (Composer), Andrea Marcon (Conductor), Venice Baroque Orchestra (Orchestra)  Format: Audio CD</p>
