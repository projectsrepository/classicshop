...
<body>
    ...
    <div class="container" style="margin-top:50px ">
        <div class="row">
            <div class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/mozart1.jpg" class="img-fluid mx-auto d-block" alt="mozart pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Mozart - The Masterworks (40 CD Set)</h2><br>
				<p class="text-primary">Wolfgang Amadeus Mozart (Composer), Jaap ter Linden, Florian Heyerick (Conductor), & 2 more  Format: Audio</p><br>
                ...
                <p>The Masterworks Series:<br>
				   ...
				   <span class="fa fa-star checked"></span>
			       <span class="fa fa-star checked"></span>
				   <span class="fas fa-star-half-alt checked"></span><br>
