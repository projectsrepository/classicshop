...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/beethoven_hahn.jpg" class="img-fluid mx-auto d-block" alt="hahn pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Beethoven: Violin Concerto</h2>
				<p class="text-primary">Ludwig van Beethoven (Composer), Leonard Bernstein (Composer), David Zinman (Conductor),
				Baltimore Symphony Orchestra (Orchestra), Hilary Hahn (Performer)  Format: Audio CD</p>
