...
<body>
    ...
    <div class="container" style="margin-top:50px ">
        <div class="row">
            <div class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/schumann2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Schumann: Best Symphonies</h2><br>
				<p class="text-primary">Robert Schumann (Composer), Leonard Bernstein (Conductor), Vienna Philharmonic Orchestra (Orchestra)  Format: Audio CD</p><br>
                ...
                <p>Vienna Philharmonic Orchestra:<br>
