...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/beethoven_piano2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Beethoven: Piano Concertos Nos. 1-5</h2>
				<p class="text-primary">Ludwig van Beethoven (Composer), Claudio Abbado (Conductor), Berliner Philharmoniker (Orchestra), Maurizio Pollini (Performer)  Format: Audio CD</p>
