...
<body>
    ...
    <div class="container" style="margin-top:50px ">
        <div class="row">
            <div class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/mendelssohn2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">The Best of Mendelssohn (2 CD Set)</h2><br>
				<p class="text-primary">Felix Mendelssohn (Composer), Frans Brüggen (Conductor), Arpad Jóo (Conductor),
				Emmy Verhey (Performer), Derek Han (Performer), Stephen Gunzenhauser (Performer), Radio Chamber Orchestra (Orchestra),
				Budapest Symphony Orchestra (Orchestra), Israel Chamber Orchestra (Orchestra)  Format: Audio CD</p><br>
                ...
                <p>Budapest Symphony Orchestra et ali:<br>
				   Frans Brüggen et ali<br>
				   Original Release Date : 2007<br>
				   <span class="fa fa-star checked"></span>
					<span class="fa fa-star checked"></span>
					<span class="fa fa-star checked"></span>
					<span class="fa fa-star checked"></span>
					<span class="fa fa-star"></span><br>
				   4.6 out of 5 stars<br>
				   Audio CD<br>
                   €17.00<br>
