...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/handel_coronation.jpg" class="img-fluid mx-auto d-block" alt="hahn pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Handel: Coronation Anthems</h2>
				<p class="text-primary">PRESTON / ENGLISH CONCERT / PINNOCK (Artist), HANDEL,GEORGE FRIDERIC (Composer),
				PINNOCK,TREVOR (Composer), ENGLISH CONCERT (Composer)  Format: Audio CD</p>
