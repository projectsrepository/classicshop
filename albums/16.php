...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/brandenburg2.jpg" class="img-fluid mx-auto d-block" alt="hahn pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Bach: Brandenburg Concertos</h2>
				<p class="text-primary">Johann Sebastian Bach (Composer), Christopher Hogwood (Conductor), 
				The Academy of Ancient Music (Orchestra), Christophe Rousset (Performer), Monica Huggett (Performer),
				Catherine Mackintosh (Performer), Christopher Hirons (Performer), Stephen Hammer (Performer)  Format: Audio CD</p>
                ...
                <p>The Academy of Ancient Music:<br>
