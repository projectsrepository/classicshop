...
<body>
    ...
    <div class="container" style="margin-top:50px ">
        <div class="row">
            <div class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/rossini1.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Rossini: Overtures</h2><br>
				<p class="text-primary">Rossini: Overtures by Chamber Orchestra of Europe [Orchestra], Clauddio Abbado (Conductor), Format: Audio</p><br>
                ...
                <p>Chamber Orchestra of Europe:<br>
				   Claudio Abbado<br>
				   Original Release Date : 2012<br>
