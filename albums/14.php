...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/tchaikovski_violin2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Tchaikovsky: Violin Concerto;Sibelius: Violin Concerto</h2>
				<p class="text-primary">Tchaikovsky , Sibelius (Composer), Daniel Barenboim (Conductor), Staatskapelle Berlin (Orchestra), Lisa Batiashvili (Violin) Format: Audio CD</p>
