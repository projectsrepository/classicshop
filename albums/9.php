...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/tedeum2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Charpentier - Te Deum </h2>
				<p class="text-primary">Marc-Antoine Charpentier (Composer), William Christie (Conductor), Les Arts Florissants (Orchestra)  Format: Audio CD</p>
                ...
                <p>Les Arts Florissants:<br>
				  William Christie<br>
				   Original Release Date : 2005<br>
