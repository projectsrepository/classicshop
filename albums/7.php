...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/camille2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Saint-Saens: Symphonies Nos. 1 - 5</h2>
				<p class="text-primary">Camille Saint-Saëns (Composer), Jean Martinon (Conductor), Orchestre National de l'ORTF (Orchestra)  Format: Audio CD</p>
                ...
                <p>Orchestre National de l'ORTF:<br>
				  Jean Martinon<br>
