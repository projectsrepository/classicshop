...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/mozart_horn2.jpg" class="img-fluid mx-auto d-block" alt="hahn pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Mozart: Concertos for Horn</h2>
				<p class="text-primary">Wolfgang Amadeus Mozart (Composer), Mathieu Lussier(Conductor), 
				Les Violons du Roy (Orchestra), Louis-Philippe Marsolais (Performer)  Format: Audio CD</p>
