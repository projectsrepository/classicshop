...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/bach_masterworks2.jpg" class="img-fluid mx-auto d-block" alt=" pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">Bach: Sacred Masterworks</h2>
				<p class="text-primary">J. S. Bach (Composer), Karl Munchinger (Conductor), Stuttgart Kammerorchester (Orchestra)  Format: Audio CD</p>
                ...
                <p>Stuttgart Kammerorchester:<br>
				  Karl Munchinger<br>
