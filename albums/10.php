...
<body>
    ...
    <div  class="container" style="margin-top:50px ">
        <div class="row">
            <div  class="col-sm-6">
                <h2 class="text-center"></h2><img src="pics2/williams2.jpg" class="img-fluid mx-auto d-block" alt="rossini pic" style="height: 350px;">
                <br>
            ...
            <div class="col-sm-6">
                <h2 class="text-left">John Williams 40 Years Of Film Music </h2>
				<p class="text-primary">John Williams (Composer), John Williams (Conductor), The City Of Prague Philharmonic Orchestra (Orchestra)  Format: Audio CD</p>
                ...
                <p>The City Of Prague Philharmonic Orchestra:<br>
				  John Williams<br>
